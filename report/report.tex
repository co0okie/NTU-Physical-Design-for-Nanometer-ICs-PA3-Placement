...
相反地，當 $w_b \ge w_m$ 時，module 移動時其覆蓋在各 bin 的重疊面積總和近乎守恆，在等密度區域中的受力會完美抵消，呈現平坦的受力分佈，讓 module 能夠平滑且自然地擴散。因此本作業最終將 bin size 設定為：

$$w_b \approx 2 \min_{m \in M} w_m, \quad h_b \approx 2 \min_{m \in M} h_m$$
